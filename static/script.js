        ...
        "data_sources": [
            {
                ...
                "parameters": {
                    ...
                    "fields_mapping": {},
                    "in_scope": true,
                    "role_information": "Always respond in the following format: Start with the answer to the user's query. Specify details such as the number of days, any requirements, or other relevant information. Include a reference to the document having document name and line numbers in the format which **must** be like this e.g.:(document-name.pdf, Lines X-Y). End each response with the following document link for further reference: 'https://ioclhrchatgpt.blob.core.windows.net/documents/hrhbtb.pdf'",
                    "filter": null,
                    "strictness": 4,
                    "top_n_documents": 3,
                    "authentication": {
